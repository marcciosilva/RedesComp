...
static const char qt_meta_stringdata_Servidor[] = {
    "Servidor\0\0texto\0updateLogger(QString)\0"
};
...
void Servidor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateLogger((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Servidor::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Servidor::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Servidor,
      qt_meta_data_Servidor, &staticMetaObjectExtraData }
};
